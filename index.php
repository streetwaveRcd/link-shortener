...
<html>
    ...
    <body class="fade-in-ii">
        <form class="form-wrapper cf" method="post" action="" >
            <font size="8" style="font-family: 'Seaweed Script', cursive;" alt="URL SHORTNER by MISTER FREEDOM"><?php echo $sitename; ?></font><p />
        ...
        <div class="byline"><p>URL Shortner Designed and Developed by <a href="http://www.facebook.com/misterfreedom.sailesh">MISTER FREEDOM</a></p></div>
    </body>
</html>
